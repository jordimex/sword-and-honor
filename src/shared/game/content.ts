...
const weaponTemplates: Array<{
  ...
  { base: "Rusty Sword", family: "longsword", attack: 5, speed: 0 },
  { base: "Iron Sword", family: "longsword", attack: 8, speed: 0 },
  { base: "Knightblade", family: "longsword", attack: 11, speed: 1 },
  { base: "Border Greatsword", family: "greatsword", attack: 13, speed: -2 },
  { base: "Raider Axe", family: "axe", attack: 10, speed: -1 },
  { base: "Marshal Hammer", family: "warhammer", attack: 11, speed: -2 },
  { base: "Ashwood Spear", family: "spear", attack: 9, speed: 2 },
  { base: "Crusader Mace", family: "mace", attack: 10, speed: 0 },
  {
    base: "Road Dagger",
    family: "dagger",
    attack: 7,
  ...
  { base: "Tournament Blade", family: "longsword", attack: 12, speed: 1 },
  {
    base: "Apprentice Wand",
    family: "wand",
    attack: 7,
    speed: 1,
    critChance: 0.04,
